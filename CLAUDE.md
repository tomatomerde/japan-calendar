<!-- テンプレート原本: dev-standards/CLAUDE.template.md @ acd9175。共通部分（「ここから下は共通」以降）を修正したら原本にも反映すること -->
...
<!-- 以下は dev-standards の common/CLAUDE.common.md から自動同期（@ 0a5f7ee）。マーカーの内側を手で編集しないこと -->
