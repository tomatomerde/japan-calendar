...
`japan-calendar` is pre-1.0. Fixes go into the next release from `main`; released
...
[**Report a vulnerability**](https://github.com/tomatomerde/japan-calendar/security/advisories/new).
...
as vulnerabilities. Holiday data comes from the Cabinet Office CSV and era data from
the law; if the upstream source itself is wrong, the fix belongs upstream and this
project tracks it.